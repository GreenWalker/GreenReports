package fancyfull.main.java.mkremins.fanciful;
...
import fancyfull.main.java.net.amoebaman.util.ArrayWrapper;
...
import static fancyfull.main.java.mkremins.fanciful.TextualComponent.rawText;
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	...
	public FancyMessage(final String firstPartText) {
		this(rawText(firstPartText.replaceAll("&", "§")));
	}
	...
	*/
	...
	public FancyMessage then(final String text) {
		return then(rawText(text.replaceAll("&", "§")));
	}
